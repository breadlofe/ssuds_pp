...
TEST_F(TestFixture, Append2)
{
    test_lf.append(1.0f);
    EXPECT_EQ(test_lf.size(), 1);
}

// TEST_F(TestFixture, Append3)
// {
//     test_ls.append("Bob");
//     EXPECT_EQ(test_ls.size(), 1);
// }

TEST_F(TestFixture, Append4)
{
    test_li.append(1);
    test_li.append(2);
...
TEST_F(TestFixture, Prepend1)
{
    test_li.prepend(1);
    EXPECT_EQ(test_li.size(), 1);
}

TEST_F(TestFixture, AppendandPrepend1)
{
    test_li.append(1);
    test_li.prepend(3);
    EXPECT_EQ(test_li.size(), 2);
...
TEST_F(TestFixture, BracketOP1)
{
    test_li.append(1);
    EXPECT_EQ(test_li[0],1);
}

TEST_F(TestFixture, BracketOP2)
{
    test_li.append(1);
    test_li.prepend(3);
